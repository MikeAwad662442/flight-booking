...
INSERT INTO "new_Airport" ("country", "createdAt", "iata_code", "icao_code", "id", "latitude", "longitude", "name", "updatedAt") SELECT "country", "createdAt", "iata_code", "icao_code", "id", "latitude", "longitude", "name", "updatedAt" FROM "Airport";
DROP TABLE "Airport";
